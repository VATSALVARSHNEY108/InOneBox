...
TOOL_CATEGORIES = {
    "AI Tools": {"icon": "🤖", "description": "Artificial intelligence and machine learning tools", "module": ai_tools, "color": "#FFFFFF", "background-color": "#000000"},
    "Audio/Video Tools": {"icon": "🎵", "description": "Media processing and editing tools", "module": audio_video_tools, "color": "#FFFFFF", "background-color": "#000000"},
    "Coding Tools": {"icon": "💻", "description": "Programming utilities and development tools", "module": coding_tools, "color": "#FFFFFF", "background-color": "#000000"},
    "Color Tools": {"icon": "🌈", "description": "Color palettes, converters, and design tools", "module": color_tools, "color": "#FFFFFF", "background-color": "#000000"},
    "CSS Tools": {"icon": "🎨", "description": "CSS generators, validators, and design tools", "module": css_tools, "color": "#FFFFFF", "background-color": "#000000"},
    "Data Tools": {"icon": "📊", "description": "Data analysis and visualization tools", "module": data_tools, "color": "#FFFFFF", "background-color": "#000000"},
    "File Tools": {"icon": "📁", "description": "File management and conversion utilities", "module": file_tools, "color": "#FFFFFF", "background-color": "#000000"},
    "Image Tools": {"icon": "🖼️", "description": "Image editing, conversion, and analysis tools", "module": image_tools, "color": "#FFFFFF", "background-color": "#000000"},
    "Science/Math Tools": {"icon": "🧮", "description": "Scientific calculators and mathematical tools", "module": science_math_tools, "color": "#FFFFFF", "background-color": "#000000"},
    "Security/Privacy Tools": {"icon": "🔒", "description": "Cybersecurity, privacy, and encryption tools", "module": security_tools, "color": "#FFFFFF", "background-color": "#000000"},
    "Social Media Tools": {"icon": "📱", "description": "Social media management and analytics", "module": social_media_tools, "color": "#FFFFFF", "background-color": "#000000"},
    "SEO/Marketing Tools": {"icon": "📈", "description": "Search optimization and marketing analytics", "module": seo_marketing_tools, "color": "#FFFFFF", "background-color": "#000000"},
    "Text Tools": {"icon": "📝", "description": "Text processing, analysis, and manipulation tools", "module": text_tools, "color": "#FFFFFF", "background-color": "#000000"},
    "Web Developer Tools": {"icon": "🌐", "description": "Web development and testing utilities", "module": web_dev_tools, "color": "#FFFFFF", "background-color": "#000000"},
    "Portfolio": {"icon": "📁", "description": "Portfolio and project showcase", "module": web_dev_tools, "color": "#FFFFFF", "background-color": "#000000"}
}
