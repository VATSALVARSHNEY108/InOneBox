...
class AIClient:
    ...
    def analyze_image(self, image_data: bytes, prompt: str = "Analyze this image", model: str = "gemini",
        ...
        try:
            ...
            api_key = self._get_gemini_key()
            if not api_key:
                return "Gemini API key not available for image analysis."
            ...
            mime_type = mime_type_map.get(image_format.upper(), 'image/jpeg')
    ...
    def generate_image(self, prompt: str, provider: str = "auto", model: str = "gemini", size: str = "1024x1024") -> \
    Optional[bytes]:
        ...
        # Generate image using Gemini only
        try:
    ...
    def detect_language(self, text: str, detection_mode: str = "Quick Detection", include_confidence: bool = True) -> \
    Dict[str, Any]:
